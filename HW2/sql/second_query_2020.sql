with "continent_country_cases"("Continent Name", "Country Name", "Date","ConfirmedCases") as(
	...
	where '2020/05/25'<=cases."Date" and cases."Date"<='2020/06/01'
), "7_day_average_2020"("Continent Name", "Country Name", "New Cases Average") as(
	...
	select "7_day_average_2020"."Continent Name", "7_day_average_2020"."Country Name",
		case "7_day_average_2020"."New Cases Average" 
		when 0 then "2020_06_01"."StringencyIndex_Average_ForDisplay"
		else "2020_06_01"."StringencyIndex_Average_ForDisplay" / "7_day_average_2020"."New Cases Average" end
	from (
		...
		on country_to_continent.three_letter_country_code=country.three_letter_country_code
		on continent.continent_code=country_to_continent.continent_code 
		where indices."Date"='2020/06/01' and indices."StringencyIndex_Average_ForDisplay">0
	) as "2020_06_01" join "7_day_average_2020"
	on "2020_06_01".country_name="7_day_average_2020"."Country Name" and "2020_06_01".continent_name="7_day_average_2020"."Continent Name"
)
