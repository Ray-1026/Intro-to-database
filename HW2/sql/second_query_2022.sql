with "continent_country_cases"("Continent Name", "Country Name", "Date","ConfirmedCases") as(
	...
	where '2022/05/25'<=cases."Date" and cases."Date"<='2022/06/01'
), "7_day_average_2022"("Continent Name", "Country Name", "New Cases Average") as(
	...
	select "7_day_average_2022"."Continent Name", "7_day_average_2022"."Country Name",
		case "7_day_average_2022"."New Cases Average" 
		when 0 then "2022_06_01"."StringencyIndex_Average_ForDisplay"
		else "2022_06_01"."StringencyIndex_Average_ForDisplay" / "7_day_average_2022"."New Cases Average" end
	from (
		...
		on country_to_continent.three_letter_country_code=country.three_letter_country_code
		on continent.continent_code=country_to_continent.continent_code 
		where indices."Date"='2022/06/01' and indices."StringencyIndex_Average_ForDisplay">0
	) as "2022_06_01" join "7_day_average_2022"
	on "2022_06_01".country_name="7_day_average_2022"."Country Name" and "2022_06_01".continent_name="7_day_average_2022"."Continent Name"
)
